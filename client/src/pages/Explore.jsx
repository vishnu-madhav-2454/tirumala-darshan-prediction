...
const PLACES = [
  {
    ...
    tips: "Arrive early morning for shorter queues. Sarva Darshan is free. Special Entry Darshan (₹300) offers faster access.",
  ...
  },
  {
    ...
    entryFee: "Free",
    description: "A remarkable natural rock formation arch, believed to be 2.5 billion years old. This geological wonder is shaped like a hood of a serpent and resembles the form of Lord Venkateswara's Sudarshana Chakra. It is one of only two such natural rock arches in Asia.",
    highlights: ["2.5 billion year old natural arch", "One of two such formations in Asia", "Resembles Lord's Sudarshana Chakra", "Short trek from Tirumala temple"],
  ...
  },
  {
    ...
    photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Axis_axis_%28Nagarahole%2C_2010%29.jpg/1280px-Axis_axis_%28Nagarahole%2C_2010%29.jpg",
  ...
  },
  {
    ...
    description: "A magnificent 11th-century hilltop fort that served as the capital of the Vijayanagara Empire's later rulers. The fort complex includes the Raja Mahal and Rani Mahal palaces, which now house an archaeological museum. Light and sound shows narrate the fort's glorious history.",
    highlights: ["11th century Vijayanagara fort", "Raja Mahal & Rani Mahal palaces", "Archaeological museum inside", "Sound & light show in evenings"],
  ...
  },
  {
    ...
    photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Sri_Kalahasti_temple_2.jpg/1280px-Sri_Kalahasti_temple_2.jpg",
