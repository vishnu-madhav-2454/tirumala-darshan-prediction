...
const QUICK_QUESTIONS = {
  ...
  ta: [
    "தரிசன வகைகள் என்ன?",
    "டிரெஸ் கோட் என்ன?",
    "திருமலை எப்படி செல்வது?",
    "லட்டு பிரசாதம் பற்றி சொல்லுங்கள்",
    "ஆன்லைன் புக்கிங் எப்படி?",
    "பிரம்மோத்சவம் எப்போது?",
    "திருமலையில் ஹோட்டல் விலைகள்?",
    "சென்னையிலிருந்து திருப்பதி எப்படி?",
  ],
  ml: [
    "ദർശന തരങ്ങൾ എന്തൊക്കെ?",
    "ഡ്രസ് കോഡ് എന്താണ്?",
    "തിരുമല എങ്ങനെ എത്തിച്ചേരാം?",
    "ലഡ്ഡു പ്രസാദത്തെ കുറിച്ച് പറയൂ",
    "ഓൺലൈൻ ബുക്കിംഗ് എങ്ങനെ?",
    "ബ്രഹ്മോത്സവം എപ്പോൾ?",
    "തിരുമലയിലെ ഹോട്ടൽ വിലകൾ?",
    "ചെന്നൈയിൽ നിന്ന് തിരുപ്പതി എങ്ങനെ?",
  ],
  kn: [
    "ದರ್ಶನ ವಿಧಗಳು ಯಾವುವು?",
    "ಡ್ರೆಸ್ ಕೋಡ್ ಏನು?",
    "ತಿರುಮಲಕ್ಕೆ ಹೇಗೆ ತಲುಪುವುದು?",
    "ಲಡ್ಡು ಪ್ರಸಾದದ ಬಗ್ಗೆ ಹೇಳಿ",
    "ಆನ್‌ಲೈನ್ ಬುಕ್ಕಿಂಗ್ ಹೇಗೆ?",
    "ಬ್ರಹ್ಮೋತ್ಸವ ಯಾವಾಗ?",
    "ತಿರುಮಲದಲ್ಲಿ ಹೋಟೆಲ್ ಬೆಲೆಗಳು?",
    "ಚೆನ್ನೈಯಿಂದ ತಿರುಪತಿಗೆ ಹೇಗೆ?",
  ],
};
